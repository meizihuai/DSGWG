...
namespace DSGWGPages
{
    ...
    public class TssMsgHelper
    {
        ...
        public TssMsg Msg2TssMsg(byte ctrl, string datatype, string functype, string canshu, byte[] shuju)
        {
        ...
        public byte[] Tssmsg2byte(TssMsg tm)
        {
